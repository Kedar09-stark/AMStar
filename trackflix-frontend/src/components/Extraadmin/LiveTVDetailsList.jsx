  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-24 pb-12">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-extrabold text-sky-500 drop-shadow">
          📺 Live TV Show List
        </h2>
      </div>
      ...
      <div className="flex justify-end mb-6">
        <button
          onClick={onAdd}
          className="inline-flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white font-semibold px-6 py-2.5 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105"
      ...
      <div className="overflow-x-auto border border-slate-200 rounded-xl shadow-lg bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
        <table className="min-w-full text-sm md:text-base">
          <thead>
            <tr className="bg-gradient-to-r from-sky-600 to-purple-700 text-white uppercase font-semibold tracking-wider">
            ...
            {liveTVDetails.length === 0 ? (
              ...
              liveTVDetails.map((item, idx) => (
                ...
                >
                  ...
                  <td
                    className="py-3 px-4 font-semibold max-w-xs truncate"
                    title={item.title}
                  >
                    {item.title}
                  </td>
                  ...
                  <td className="py-3 px-4 text-center">
                    <div className="flex justify-center gap-2 flex-wrap">
                      <button
                        onClick={() => onEdit(item)}
                        className="px-4 py-1.5 text-xs bg-sky-600 hover:bg-sky-700 text-white font-semibold rounded-full transition duration-200"
                      ...
                      <button
                        ...
                        className="px-4 py-1.5 text-xs bg-rose-600 hover:bg-rose-700 text-white font-semibold rounded-full transition duration-200"
