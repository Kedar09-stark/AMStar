// D:\trackflix1\4loopers\trackflix-frontend\src\userdeshbord\RatingMovieCard.jsx
...
const RatingMovieCard = ({ movie, onRate }) => {
  ...
  return (
    <article
      tabIndex={0}
      className="bg-white rounded-lg shadow-md max-w-xs mx-auto"
    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-yellow-500 mt-1">⭐ {userRating.toFixed(1)}</p>
